/* Generated By:JJTree&JavaCC: Do not edit this line. ArbolTokenManager.java */
package Aritmetica;

/** Token Manager. */
public class ArbolTokenManager implements ArbolConstants
{
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 7:
                  ...
                  break;
               case 2:
                  if ((0x205000002050L & l) != 0L && kind > 10)
                     kind = 10;
                  break;
               case 9:
                  if (curChar != 95)
                  ...
                  break;
               case 12:
                  if ((0x20100000201000L & l) != 0L && kind > 6)
                     kind = 6;
                  break;
               case 13:
                  if (curChar == 85)
...
/** Constructor. */
public ArbolTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public ArbolTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
